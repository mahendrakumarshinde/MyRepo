...
class IUMPU9250
{
  public:
    ...
    float getAx() { return m_a[X]; }
    void setAx(float val) { m_a[X] = val; }
    float getAy() { return m_a[Y]; }
    void setAy(float val) { m_a[Y] = val; }
    float getAz() { return m_a[Z]; }
    void setAz(float val) { m_a[Z] = val; }
