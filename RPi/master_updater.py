...
def create_database():
    ...
    conn=sql_connect(db_name)
    x=conn.cursor()
    x.execute("CREATE TABLE Feature_Dictionary(MAC_ADDRESS VARCHAR(255), Feature_ID INT(11), Feature_Name VARCHAR(255), Threshold_1 FLOAT, Threshold_2 FLOAT, Threshold_3 FLOAT, Status INT(11), Machine_Name VARCHAR(255))")
