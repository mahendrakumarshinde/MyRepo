...
// more states.
float featureWarningThreshold[NUM_FEATURES] = {50,
                                               10000,
                                               //10000,
                                               6,
                                               0.4,
...
float featureDangerThreshold[NUM_FEATURES] = {200,
                                              100000,
                                              //100000,
                                              8,
                                              0.45,
...
String header = "HTTP/1.1 200 OK\r\n";
  ...
  Serial2.print(ch_id);
  Serial2.print(",");
  Serial2.println(content.length());
  if(wait_for_esp_response(20000)) {
