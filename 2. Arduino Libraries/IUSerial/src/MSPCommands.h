...
namespace MSPCommand
{
	...
	SEND_RAW_DATA,	   //send raw data command	
        ...
        SEND_HTTP_CONNECTION_INFO,
	SEND_MQTT_CONNECTION_INFO,
        SEND_MQTT_HASH,
        SEND_HTTP_HASH,
	...
	GET_ACCOUNTID,
        ...
        OTA_ESP_DNLD_STATUS,
	OTA_INIT_REQUEST,
        // Battery Managment MSP Commands 
        SEND_BATTERY_LEVEL,
        SEND_BATTERY_MODE,
	...
	SEND_SENSOR_STATUS,
        GET_ESP_RSSI,
	SET_MQTT_TLS_FLAG,
        /****** To manage the MQTT Connection Status ******/
        MQTT_ALERT_CONNECTED,
        MQTT_ALERT_DISCONNECTED,
        MQTT_CONNECT,
        MQTT_DISCONNECT,

        /******* Certificates managment Commands **********/
        SET_TLS_CERT_URI,
        SET_TLS_KEY_URI,
        TLS_INIT_ACK,
        CERT_SET_START,
        ...
        // get set Certificates Commands
        GET_HTTP_RESPONSE,
        SET_CERT_CONFIG_URL,
        GET_CERT_COMMOM_URL,
        GET_CERT_DOWNLOAD_CONFIG,
        
        /******** ESP32 Flash File System commads *********/
        ...
        SEND_CERT_HASH,        
        SEND_DIAG_CERT_HASH,
        GET_CERT_CONNECTION_INFO,
        GET_DIAG_CERT_CONNECTION_INFO,
        RECEIVE_ESP_SYNC_RSP
	// ESP32 MSP Commands
	//ESP_DEBUG_TO_STM_HOST
    };
}
