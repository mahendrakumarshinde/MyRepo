...
namespace IUComponent
{
     ...
     */
    class IUBMX055Acc : public Sensor
    {
        public:
            ...
            IUBMX055Acc(IUI2C *iuI2C, uint8_t id=100,
                        FeatureBuffer *accelerationX=NULL,
                        FeatureBuffer *accelerationY=NULL,
                        FeatureBuffer *accelerationZ=NULL);
            virtual ~IUBMX055Acc() {}
