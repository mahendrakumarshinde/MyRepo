...
namespace IUComponent
{
     ...
     */
    class IUBMX055Gyro : public Sensor
    {
        public:
            ...
            enum bandwidthOption : uint8_t {
                BW_2000Hz523Hz, // 2000 Hz ODR and filtered (bandwidth 523Hz)
                BW_2000Hz230Hz,
                BW_1000Hz116Hz,
                BW_400Hz47Hz,
                BW_200Hz23Hz,
            ...
            IUBMX055Gyro(IUI2C *iuI2C, uint8_t id=100,
                         FeatureBuffer *tiltX=NULL, FeatureBuffer *tiltY=NULL,
                         FeatureBuffer *tiltZ=NULL);
