...
import com.idragonit.bleexplorer.fragment.HistoryFragment;
...
//        mDeviceAddress = "test";
        ...
        mFeatureMap = DaoUtils.getFeatures(this, mDeviceName, mDeviceAddress);
        ...
        mBtnConnect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ISTEST) {
                    testValue++;
                    if (testValue % 4 == 0) {
                        displayData("test,00,90,0001,30.94,0002,30.94");
                    }
                    if (testValue % 4 == 1) {
                        displayData("test,01,80,0001,20.94,0002,20.94");
                    }
                    if (testValue % 4 == 2) {
                        displayData("test,02,70,0001,40.94,0002,40.94");
                    }
                    if (testValue % 4 == 3) {
                        displayData("test,03,60,0001,25.94,0002,25.94");
                    }
                }
            }
        });
    ...
    public void sendData(int[] threshold) {
        String data = "0000-" + String.format("%04d", threshold[1]);
        for (int i = 2; i < 4; i++) {
