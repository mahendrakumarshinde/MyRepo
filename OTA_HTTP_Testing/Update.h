  ...
  public:
    ...
    */
    ...
    /*
      ...
      Usable for slow streams like Serial
    */
    size_t writeStream_OTA(Stream &data); // Customizes function _MSS
    size_t writeStream_SPIFFS(String fwpath, long FileLength); // Customizes function _MSS
    /*
    ...
    */
    ...
    bool end1(bool evenIfRemaining = false);
