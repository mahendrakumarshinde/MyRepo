...
public:
	...
	static void init_hash(void *ctxBuf, char *arg, size_t argSize);
	static void make_chunk_hash(void *ctxBuf, char *arg, size_t argSize);
	static unsigned char * make_final_hash(void *ctxBuf);
