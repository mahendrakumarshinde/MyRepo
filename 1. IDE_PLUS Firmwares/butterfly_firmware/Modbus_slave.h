...
{
public:
	IUmodbus(HardwareSerial *SelectSerial, uint8_t Tx_pin, uint8_t Tx1_pin);
...
protected:
	...
	uint8_t TxEnablePin;    //RE -Active low enable pin 
	uint8_t TxEnable1pin;  //DE -Active high enable pin
