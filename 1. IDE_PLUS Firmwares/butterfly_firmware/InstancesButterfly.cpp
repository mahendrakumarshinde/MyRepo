...
#ifdef BUTTERFLY_V04
    GPIORGBLed rgbLed(A5, A3, A4);
#else
    GPIORGBLed rgbLed(A5, A3, A0);
#endif

LedManager ledManager(&regLed);
...
FeatureTemplate<float> pressure("PRS", 2, 1, pressureValues);
...
SignalRMSComputer<q15_t> accel128ComputerX(10,&accelRMS128X, false, true, true,
                                           ACCEL_RMS_SCALING[0]);
SignalRMSComputer<q15_t> accel128ComputerY(11, &accelRMS128Y, false, true, true,
                                           ACCEL_RMS_SCALING[1]);
SignalRMSComputer<q15_t> accel128ComputerZ(12, &accelRMS128Z, false, true, true,
                                           ACCEL_RMS_SCALING[2]);
...
FFTComputer<q15_t> accelFFTComputerX(30,
                                     &accelReducedFFTX,
                                     &accelMainFreqX,
                                     &velRMS512X,
                                     &dispRMS512X,
