...
/***** Firmware version *****/
const char FIRMWARE_VERSION[8] = "3.0.1";
...
const char MQTT_DEFAULT_SERVER_IP[50] = "mqtt.uat.infinite-uptime.com";
...
============================================================================= */
const char HTTP_DEFAULT_HOST[50] = "sandbox-api-idap.infinite-uptime.com";
